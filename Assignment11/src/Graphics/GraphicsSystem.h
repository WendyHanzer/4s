...
class GraphicsSystem : public System
{
	...
	public:
		...
		glm::quat worldRotationX;
		glm::quat worldRotationY;
		glm::mat4 worldOrigin;
		...
		/*
		*	rotates model about world
		*/
		inline glm::mat4 calculateM(const glm::mat4& model)
		{
			return worldOrigin*glm::toMat4(worldRotationY*worldRotationX)*glm::inverse(worldOrigin)*model;
		} //calculateM
		...
		{	
			projection = glm::perspective(45.0f, float(window.getSize().x)/float(window.getSize().y), .01f, 1000.0f);
