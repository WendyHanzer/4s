...
void DSPointLightPassTech::SetPointLight(const PointLightData& Light)
{
	...
	glUniform3f(m_pointLightLocation.Position, Light.modelPosition.x, Light.modelPosition.y, Light.modelPosition.z);
	glUniform1f(m_pointLightLocation.Atten.Constant, Light.attenuationConstant);
	glUniform1f(m_pointLightLocation.Atten.Linear, Light.attenuationLinear);
	glUniform1f(m_pointLightLocation.Atten.Exp, Light.attenuationExponential);
}