	...
	void loadSubMesh(unsigned int index, const aiMesh* subMesh, const unsigned int& startVertex, const unsigned int& startIndex)
	{
		...
		*/
		for (unsigned int i = 0; i < subMesh->mNumFaces; ++i)
		{
			...
			file1 << (i*3 + 0) << "{";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[0]].position[0];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[0]].position[1];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[0]].position[2];
			file1 << "}\n";
			file1 << (i*3 + 1) << "{";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[1]].position[0];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[1]].position[1];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[1]].position[2];
			file1 << "}\n";
			file1 << (i*3 + 2) << "{";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[2]].position[0];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[2]].position[1];
			file1 << ", ";
			file1 << verticesTemp[subMesh->mFaces[i].mIndices[2]].position[2];
			file1 << "}\n";
			...
			file2 << startIndex + (i*3 + 0) << "{";
			file2 << vertices[indices[startIndex + (i*3 + 0)] + 0];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 0)] + 1];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 0)] + 2];
			file2 << "}\n";
			file2 << startIndex + (i*3 + 1) << "{";
			file2 << vertices[indices[startIndex + (i*3 + 1)] + 0];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 1)] + 1];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 1)] + 2];
			file2 << "}\n";
			file2 << startIndex + (i*3 + 2) << "{";
			file2 << vertices[indices[startIndex + (i*3 + 2)] + 0];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 2)] + 1];
			file2 << ", ";
			file2 << vertices[indices[startIndex + (i*3 + 2)] + 2];
			file2 << "}\n";
		} //for
